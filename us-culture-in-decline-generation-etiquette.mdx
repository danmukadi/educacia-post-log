...
side_image: '/img/etiquette3.jpg'
author: 'Educacia'
author_profile: '/img/profile.jpg'
tags: ['education']
---
We can only go so far if we continue on the path we’re on. Mass lawlessness, declining mental health, breakdown of community, 
...
conclusions of a society that places itself over everything. 
